...
8. 配置高级设置，包括主机名、USB、DNS、CPU启动模式，高可用模式，隔离组，自定义数据。
   ...
   ![vmorder](../images/userguide/setup.png)
...
![vmdiskinfo](../images/userguide/usb2.png)
...
![vmevent](../images/userguide/vmevent.png)
...
![vmreinstall](../images/userguide/vmreinstall_1_1.png)

重装系统时若选择的镜像既无cloud-init特性也无qemu-ga特性，则不支持密码重置，重装后的登录密码为镜像密码，如下图所示：

![vmreinstall](../images/userguide/vmreinstall_1_2.png)
