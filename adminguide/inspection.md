...
![](../images/adminguide/createinspection.png)
...
![](../images/adminguide/inspectionlist.png)
...
![](../images/adminguide/downloadinspection.png)

## 13.5 删除巡检报告
支持用户删除巡检报告，可支持删除【完成】状态的巡检报告。用户可通过巡检列表进行巡检报告的删除操作。

![](../images/adminguide/deleteinspection.png)
