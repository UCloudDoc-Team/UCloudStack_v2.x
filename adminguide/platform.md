...
管理员为平台设置租户可使用 VPC CIDR 网段，默认为 `10.0.0.0/16,172.16.0.0/16,192.168.0.0/16` 三段私有网络地址。10网段支持创建最大8位掩码地址，192和172网段支持创建最大16位掩码地址，172网段支持172.16.0.0/24～172.29.0.0/24，管理员可根据平台实际使用情况进行修改。
