...
返回结果如下类似：
![](../images/customimage/virtio_check.png)
...
```
返回类似如下结果：
![](../images/customimage/virtio_check_02.png)
...
返回结果类似如下图：
![](../images/customimage/kernel_01.png)
